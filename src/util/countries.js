const countries = [
  ...
  {
    'country': 'Armenia',
    'states': ['Aragatsotn', 'Ararat', 'Armavir', 'Gegharkunik', 'Kotayk', 'Lorri', 'Shirak', 'Syunik', 'Tavush', 'VayotsDzor', 'Yerevan']
  },
  {
    'country': 'Australia',
  ...
  {
    'country': 'Seychelles',
    'states': ['Anse aux Pins', 'Anse Boileau', 'Anse Etoile', 'Anse Louis', 'Anse Royale', 'Baie Lazare', 'Baie Sainte Anne', 'Beau Vallon', 'Bel Air', 'Bel Ombre', 'Cascade', 'Glacis', 'GrandAnse', 'GrandAnse', 'La Digue', 'La Riviere Anglaise', 'Mont Buxton', 'Mont Fleuri', 'Plaisance', 'Pointe La Rue', 'Port Glaud', 'Saint Louis', 'Takamaka']
  },
  {
